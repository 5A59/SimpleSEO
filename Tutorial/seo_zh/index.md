...
*   [ ] 你是否把主要精力放在创作**真正优秀的内容**上，期待别人主动链接？
*   [ ] 如果你的网站属于特定行业，是否已提交到**最重要的几个**行业目录？
*   [ ] 你是否**定期使用** Ahrefs Webmaster Tools 检查并**修复了那些带有外部链接的 404 页面** (通过 301 重定向)？
*   [ ] 你是否知道**购买链接是高风险行为**，并决定不这样做？
*   [ ] (可选) 如果你喜欢写作，是否考虑过为相关网站写**客座博客**？
